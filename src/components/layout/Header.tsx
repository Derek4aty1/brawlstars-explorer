  ...
  return (
    <header className="z-50 sticky top-0 bg-black h-[64px] flex">
      <nav className="flex w-full">
        ...
        <a href="https://github.com/Derek4aty1/brawlstars-explorer" target="_blank" draggable={false} className="m-3 ml-auto flex items-center transition-transform hover:scale-110 active:scale-95">
          <Image
